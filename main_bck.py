...
import argparse
print('Libs Tensorflow')
import tensorflow as tf
import numpy as np
import pandas as pd
print('Libs Customizadas')
import utils
from metric import ndcg
from pprint import pprint
from GAR.GAR import GAR

print('Leitura das libs com sucesso')
...
parser.add_argument('--alpha', type=float, default=0.01, help='param in GAR')
parser.add_argument('--beta', type=float, default=0.07, help='param in GAR')
